    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="class.php?id=<?php echo $classId; ?>">
                        <?php echo $classCode; ?>
                    </a></li>
        ...
        <!-- End of table div -->
        <p class="label-text-dark"><b>NOTE: </b>Three instances of being late are considered equivalent to one absence
            and will be included in the total number of absences if and when they occur.</p>
        <div class="d-flex">
